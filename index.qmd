...
![Figure 1: Shows the segmentation of the trajectory without removing the static segments and the short segments](Segmentation.png) 



![Figure 2: Shows the segmentation of the trajectory with removal of the static segments and the short segments.](Statische Segmente Punkte entfernen.png)
...
![Figure 3: Boxplot shows the distribution of speed and acceleration of the means of transport used. These values were used to determine the means of transport.](transport_mode_boxplot.png)
...
![Figure 4: The map illustrates the routes taken by pedestrians, cyclists and public transport users during the day, with the latter divided into routes served by different modes of transport.](USED_transport_Infrasturcutre_onde day.png)
...
![Figure 5: The confusion matrix of the training data, which compares the "Predicted" means of transport calculated by our model with the "Actual" from Posmo.](Train_confmatrix.png)




![Figure 6: The confusion matrix of the validation data, which compares the "Predicted" means of transport calculated by our model with the "Actual" from Posmo.](Val_conf_matr.png)
