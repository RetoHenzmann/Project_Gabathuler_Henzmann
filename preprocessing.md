...
```
## Reading layer `swissTLM3D_TLM_STRASSE' from data source 
##   `C:\Users\oswal\OneDrive - ZHAW\Studium\Master\2.Semester\Patterns and Trends\Projekt\swisstlm3d_2024-03_2056_5728.shp\TLM_STRASSEN\swissTLM3D_TLM_STRASSE.shp' 
##   using driver `ESRI Shapefile'
## Simple feature collection with 2059610 features and 27 fields
## Geometry type: LINESTRING
## Dimension:     XYZ
## Bounding box:  xmin: 2485437 ymin: 1075244 xmax: 2837853 ymax: 1296226
## z_range:       zmin: 193.473 zmax: 3897.316
...
```
## Reading layer `swissTLM3D_TLM_HALTESTELLE' from data source 
##   `C:\Users\oswal\OneDrive - ZHAW\Studium\Master\2.Semester\Patterns and Trends\Projekt\swisstlm3d_2024-03_2056_5728.shp\TLM_OEV\swissTLM3D_TLM_HALTESTELLE.shp' 
##   using driver `ESRI Shapefile'
## Simple feature collection with 27509 features and 16 fields
## Geometry type: POINT
## Dimension:     XYZ
## Bounding box:  xmin: 2486195 ymin: 1076160 xmax: 2831992 ymax: 1294160
## z_range:       zmin: 127.78 zmax: 3823.621
## Projected CRS: CH1903+ / LV95 + LN02 height
```
...
```
## Reading layer `swissTLM3D_TLM_EISENBAHN' from data source 
##   `C:\Users\oswal\OneDrive - ZHAW\Studium\Master\2.Semester\Patterns and Trends\Projekt\swisstlm3d_2024-03_2056_5728.shp\TLM_OEV\swissTLM3D_TLM_EISENBAHN.shp' 
##   using driver `ESRI Shapefile'
## Simple feature collection with 55043 features and 28 fields
## Geometry type: LINESTRING
## Dimension:     XYZ
## Bounding box:  xmin: 2488168 ymin: 1076650 xmax: 2817638 ymax: 1289181
## z_range:       zmin: 194.641 zmax: 3453.526
## Projected CRS: CH1903+ / LV95 + LN02 height
```
...
```
## `summarise()` has grouped output by 'transport_mode'. You can override using the `.groups` argument.
```
